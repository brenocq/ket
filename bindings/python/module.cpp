...
const char* method_to_string(ket::Method method) {
  switch (method) {
    case ket::Method::Auto:
      return "auto";
    case ket::Method::StateVector:
      return "statevector";
    case ket::Method::Stabilizer:
      return "stabilizer";
  }
  return "auto";
}
...
PYBIND11_MODULE(_ket, m) {
  ...
  py::class_<ket::Circuit>(m, "Circuit", "A quantum circuit (a DAG of gates).")
      ...
      .def("crx",
           ...
           "Apply a controlled-Rx rotation by angle theta.")
      .def("cry",
           py::overload_cast<std::size_t, std::size_t, double>(
               &ket::Circuit::cry),
           py::arg("control"), py::arg("target"), py::arg("theta"),
           "Apply a controlled-Ry rotation by angle theta.")
      .def("crz",
           py::overload_cast<std::size_t, std::size_t, double>(
               &ket::Circuit::crz),
           py::arg("control"), py::arg("target"), py::arg("theta"),
  ...
  m.def(
      "set_num_threads", &ket::set_num_threads, py::arg("threads"),
  ...
  m.def(
      "expval",
      py::overload_cast<const ket::State&, const ket::PauliSum&>(&ket::expval),
      py::arg("state"), py::arg("hamiltonian"),
